    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-4 offset-4 rounded bg-info mt-3 py-3">
                <h2 class="text-center fw-bold" style="font-size:20px;"> Tambah Product</h2>
                <form action="{{ route('products.store') }}" class="mt-3" method="post">
                    @csrf
                    <div class="mb-1">
                        <label for="">Gambar Produk</label>
                        <input type="text" class="form-control" name="image" placeholder="Masukan Gambar Product">
                    </div>
                    <div class="mb-1">
                    ...
                    <div class="mb-1">
                        ...
                        <input type="text" class="form-control" name="stock" placeholder="Masukan Stok Product">
                    </div>
                    <div class="mb-1">
                        <label for="">Harga Produk</label>
                        <input type="text" class="form-control" name="price" placeholder="Masukan Harga Product">
                    </div>
                    <div class="mb-1">
                        <label for="">Berat Produk</label>
                        <input type="text" class="form-control" name="weight" placeholder="Masukan Berat Product">
                    </div>
                    <div class="mb-1">
